...
void read_numbers(char *main_file, char *first_num, char *second_num);
...
int main() {
    int i=0;
    char main_file[200];
    char first_num[67]; //= "09819C3D1B8BA02D5328C5CB86A699E4011F30129125EF60FC48A911458960E1";
    char second_num[67]; //= "07497DE25DE0588B1BB9F7326D6695111C60359C89D1CBE0E0602F9B91828C4A";
    ...
    read_numbers(main_file, first_num, second_num);
    ...
    //printf("\n");
    for(i=256;i>0;i--){ //reverse the number to form the actual number
    //    printf("%u", sum[i-1]);
...
void read_numbers(char *main_file, char *first_num, char *second_num){
    ...
    //while(fgets(main_file,66,stdin) != NULL){
    //    printf("%s\n", main_file);
    //    strcpy(first_num, main_file);
    //}
